...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   // Retornar el arreglo.
   // Tu código:
   var objetoMuchosUsuariosMod = objetoMuchosUsuarios.map(function(user) {
      user["esPremium"] = true;
      return user;
   })
   return objetoMuchosUsuariosMod;
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   // Tu código:
      ...
      // Retornamos el objetoProducto con la nueva propiedad agregada
